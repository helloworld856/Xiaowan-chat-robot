...
export async function addAssistantMessage(messages:string[]){//助手回复可能有多条消息，每条消息都一个头像加消息,并且用div包裹
...
//显示历史聊天记录
export function showChatHistory(chatBox:HTMLDivElement, chatHistory:ConversationItem[]){
